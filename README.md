...
2.  **Dependencies**:
    ...
    *   **Mitsuba 3**: Locally built from source. Similarly to USD, it is not included as a submodule. For compatibility, it is recommended to use commit [`e17e5185`](https://github.com/mitsuba-renderer/mitsuba3/commit/e17e5185d734ad01830070063a613bb94d71725f) (which is the version validated in our CI configuration). The `pip`-installed version of Mitsuba currently is not supported.
