...
"""Fuzz testing: perpendicular orientation rotation modification pointing DiskLight away on USD stage."""
...
def test_degenerate_disk_light_normal():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_degenerate_disk_light_normal_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_degenerate_disk_light_normal_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Rotate DiskLight to point exactly 90 deg away
  xform = UsdGeom.Xformable.Get(stage, '/root/Area')
  xform.AddRotateXYZOp(opSuffix='deg_norm').Set((90.0, 0.0, 0.0))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_degenerate_disk_light_normal_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_degenerate_disk_light_normal_modified_usd.png'
  )
  test_helpers.robust_assert_close(
