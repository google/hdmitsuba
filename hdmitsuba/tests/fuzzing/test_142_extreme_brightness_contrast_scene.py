...
"""Fuzz testing: extreme dynamic range modification across high emission and pure black absorption on USD stage."""
...
def test_extreme_brightness_contrast_scene():
  ...
  test_helpers.write_image(
      image_hd_initial,
      'test_extreme_brightness_contrast_scene_initial_hd.png',
  )
  test_helpers.write_image(
      image_usd_initial,
      'test_extreme_brightness_contrast_scene_initial_usd.png',
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Overdrive intensity and set pure black material
  rect_light = UsdLux.RectLight.Get(stage, '/root/Area/Area')
  rect_light.GetIntensityAttr().Set(10000.0)
  ...
  test_helpers.write_image(
      image_hd_modified,
      'test_extreme_brightness_contrast_scene_modified_hd.png',
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_extreme_brightness_contrast_scene_modified_usd.png',
  )
  test_helpers.robust_assert_close(
