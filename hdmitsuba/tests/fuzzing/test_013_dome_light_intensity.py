...
"""Fuzz testing: dome light addition and intensity modification on USD stage."""
...
def test_dome_light_modification():
  ...
  dome_light.CreateIntensityAttr(0.5)
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_dome_light_modification_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_dome_light_modification_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.1
  )

  # Modification: Update Dome Light intensity
  dome_light.GetIntensityAttr().Set(2.0)
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_dome_light_modification_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_dome_light_modification_modified_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_modified[..., :3], image_usd_modified, atol=0.1
  )
