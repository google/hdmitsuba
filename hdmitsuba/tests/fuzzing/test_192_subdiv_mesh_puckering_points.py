...
"""Fuzz testing: selective point puckering modification on subdivision mesh in USD stage."""
...
def test_subdiv_mesh_puckering():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_subdiv_mesh_puckering_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_subdiv_mesh_puckering_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: puckering point offsets
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_subdiv_mesh_puckering_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_subdiv_mesh_puckering_modified_usd.png'
  )
  test_helpers.robust_assert_close(
