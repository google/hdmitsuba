...
"""Fuzz testing: materials.usda roughness modification on USD stage."""
...
def test_materials_rough_modify():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_materials_rough_modify_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_materials_rough_modify_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Update roughness on ground material
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_materials_rough_modify_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_materials_rough_modify_modified_usd.png'
  )
  test_helpers.robust_assert_close(
