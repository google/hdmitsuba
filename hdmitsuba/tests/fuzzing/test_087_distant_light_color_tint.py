...
"""Fuzz testing: color tint modification on DistantLight in USD stage."""
...
def test_distant_light_color_tint():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_distant_light_color_tint_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_distant_light_color_tint_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: tint color
  dist_light = UsdLux.DistantLight.Get(stage, '/root/Area/Area')
  dist_light.GetColorAttr().Set(Gf.Vec3f(0.9, 0.2, 0.9))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_distant_light_color_tint_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_distant_light_color_tint_modified_usd.png'
  )
  test_helpers.robust_assert_close(
