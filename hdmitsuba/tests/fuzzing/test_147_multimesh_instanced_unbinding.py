...
"""Fuzz testing: instanced multi-mesh material unbinding modification on USD stage."""
...
def test_multimesh_instanced_unbinding():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_multimesh_instanced_unbinding_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_multimesh_instanced_unbinding_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: unbind materials on Mesh1, Mesh2, Mesh3
  m1 = stage.GetPrimAtPath('/root/Meshes/Mesh1')
  m2 = stage.GetPrimAtPath('/root/Meshes/Mesh2')
  m3 = stage.GetPrimAtPath('/root/Meshes/Mesh3')
  UsdShade.MaterialBindingAPI(m1).UnbindAllBindings()
  UsdShade.MaterialBindingAPI(m2).UnbindAllBindings()
  UsdShade.MaterialBindingAPI(m3).UnbindAllBindings()
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_multimesh_instanced_unbinding_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_multimesh_instanced_unbinding_modified_usd.png',
  )
  test_helpers.robust_assert_close(
