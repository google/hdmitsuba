...
"""Fuzz testing: dynamic addition of disk light to USD stage."""
...
def test_add_disk_light():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_add_disk_light_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_add_disk_light_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Define a DiskLight
  disk_light = UsdLux.DiskLight.Define(stage, '/root/NewDiskLight')
  disk_light.CreateIntensityAttr(5.0)
  disk_light.CreateColorAttr(Gf.Vec3f(0.3, 0.9, 0.3))
  disk_light.CreateRadiusAttr(1.2)
  disk_light.AddTranslateOp().Set((2, 2, 3))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_add_disk_light_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_add_disk_light_modified_usd.png'
  )
  test_helpers.robust_assert_close(
