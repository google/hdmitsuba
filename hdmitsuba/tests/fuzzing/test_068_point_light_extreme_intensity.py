...
"""Fuzz testing: extreme intensity overdrive on Point light in USD stage."""
...
def test_point_extreme_intensity():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_point_extreme_intensity_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_point_extreme_intensity_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Overdrive intensity to 10000.0
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_point_extreme_intensity_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_point_extreme_intensity_modified_usd.png'
  )
  test_helpers.robust_assert_close(
