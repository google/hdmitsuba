...
"""Fuzz testing: complex connection pruning on NodeGraph material structure in USD stage."""
...
def test_nodegraph_complex_tree_prune():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_nodegraph_complex_tree_prune_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_nodegraph_complex_tree_prune_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: prune preview_input connection
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_nodegraph_complex_tree_prune_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_nodegraph_complex_tree_prune_modified_usd.png'
  )
  test_helpers.robust_assert_close(
