...
"""Fuzz testing: extreme aspect ratio modification on RectLight in USD stage."""
...
def test_rect_height_dominate():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_rect_height_dominate_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_rect_height_dominate_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: update width and height to extreme rectangle
  rect = UsdLux.RectLight.Get(stage, '/root/Area/Area')
  rect.GetWidthAttr().Set(0.2)
  rect.GetHeightAttr().Set(10.0)
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_rect_height_dominate_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_rect_height_dominate_modified_usd.png'
  )
  test_helpers.robust_assert_close(
