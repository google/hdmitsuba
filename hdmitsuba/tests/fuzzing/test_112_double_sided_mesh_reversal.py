...
"""Fuzz testing: doubleSided mesh flag inversion on subdivision geometry in USD stage."""
...
def test_double_sided_mesh_reversal():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_double_sided_mesh_reversal_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_double_sided_mesh_reversal_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Toggle doubleSided flag
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_double_sided_mesh_reversal_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_double_sided_mesh_reversal_modified_usd.png'
  )
  test_helpers.robust_assert_close(
