...
"""Fuzz testing: degenerate bounding extent modification on USD stage."""
...
def test_degenerate_extent():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_degenerate_extent_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_degenerate_extent_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Set degenerate extent
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_degenerate_extent_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_degenerate_extent_modified_usd.png'
  )
  test_helpers.robust_assert_close(
