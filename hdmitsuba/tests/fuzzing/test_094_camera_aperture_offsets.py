...
"""Fuzz testing: camera aperture offsets modification on USD stage."""
...
def test_camera_aperture_offsets():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_camera_aperture_offsets_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_camera_aperture_offsets_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Aperture offsets
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_camera_aperture_offsets_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_camera_aperture_offsets_modified_usd.png'
  )
  test_helpers.robust_assert_close(
