...
"""Fuzz testing: pure black color override modification on USD stage."""
...
def test_bsdf_color_zero():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_bsdf_color_zero_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_bsdf_color_zero_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: diffuseColor to pure black
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_bsdf_color_zero_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_bsdf_color_zero_modified_usd.png'
  )
  test_helpers.robust_assert_close(
