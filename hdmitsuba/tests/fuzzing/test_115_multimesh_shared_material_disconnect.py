...
"""Fuzz testing: multi-mesh shared material texture disconnecting modification on USD stage."""
...
def test_multimesh_shared_material_disconnect():
  ...
  test_helpers.write_image(
      image_hd_initial,
      'test_multimesh_shared_material_disconnect_initial_hd.png',
  )
  test_helpers.write_image(
      image_usd_initial,
      'test_multimesh_shared_material_disconnect_initial_usd.png',
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: disconnect reflectance connection on mitsuba_input material
  shader = UsdShade.Shader.Get(stage, '/root/_materials/mitsuba_input/Shader')
  shader.GetInput('reflectance').ClearSources()
  ...
  test_helpers.write_image(
      image_hd_modified,
      'test_multimesh_shared_material_disconnect_modified_hd.png',
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_multimesh_shared_material_disconnect_modified_usd.png',
  )
  test_helpers.robust_assert_close(
