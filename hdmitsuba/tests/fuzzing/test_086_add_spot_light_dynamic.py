...
"""Fuzz testing: dynamic addition of SpotLight to USD stage."""
...
def test_add_spot_light_dynamic():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_add_spot_light_dynamic_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_add_spot_light_dynamic_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Define SpotLight
  spot_light = UsdLux.SphereLight.Define(stage, '/root/FuzzSpot')
  spot_light.CreateTreatAsPointAttr(True)
  spot_light.CreateIntensityAttr(500.0)
  spot_light.CreateColorAttr(Gf.Vec3f(0.9, 0.9, 0.2))
  spot_light.AddTranslateOp().Set((3, 0, 3))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_add_spot_light_dynamic_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_add_spot_light_dynamic_modified_usd.png'
  )
  test_helpers.robust_assert_close(
