...
"""Fuzz testing: complete light absorption base color modification under distant lighting in USD stage."""
...
def test_pure_absorption_infinite_falloff():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_pure_absorption_infinite_falloff_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial,
      'test_pure_absorption_infinite_falloff_initial_usd.png',
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Set diffuseColor to pure black absorption
  ...
  test_helpers.write_image(
      image_hd_modified,
      'test_pure_absorption_infinite_falloff_modified_hd.png',
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_pure_absorption_infinite_falloff_modified_usd.png',
  )
  test_helpers.robust_assert_close(
