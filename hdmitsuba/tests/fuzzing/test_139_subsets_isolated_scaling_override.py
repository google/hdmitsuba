...
"""Fuzz testing: parent Xform transformation modification above geometry subsets in USD stage."""
...
def test_subsets_isolated_scaling_override():
  ...
  test_helpers.write_image(
      image_hd_initial,
      'test_subsets_isolated_scaling_override_initial_hd.png',
  )
  test_helpers.write_image(
      image_usd_initial,
      'test_subsets_isolated_scaling_override_initial_usd.png',
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Transform parent Xform /root/Cube
  parent_xform = UsdGeom.Xformable.Get(stage, '/root/Cube')
  parent_xform.AddScaleOp(opSuffix='fuzz_s').Set((1.2, 0.8, 1.1))
  parent_xform.AddTranslateOp(opSuffix='fuzz_t').Set((0.2, -0.1, 0.2))
  ...
  test_helpers.write_image(
      image_hd_modified,
      'test_subsets_isolated_scaling_override_modified_hd.png',
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_subsets_isolated_scaling_override_modified_usd.png',
  )
  test_helpers.robust_assert_close(
