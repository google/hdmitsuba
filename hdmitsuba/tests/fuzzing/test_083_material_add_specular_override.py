...
"""Fuzz testing: specular color override modification on USD stage."""
...
def test_material_add_specular_override():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_material_add_specular_override_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_material_add_specular_override_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: explicit specularColor input
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_material_add_specular_override_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_material_add_specular_override_modified_usd.png',
  )
  test_helpers.robust_assert_close(
