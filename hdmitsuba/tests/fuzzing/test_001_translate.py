...
"""Fuzz testing: translation modification on USD stage."""
...
def test_translate_modification():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_translate_modification_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_translate_modification_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.05
  )

  # Modification: Translate Cube
  cube_xform = UsdGeom.Xformable.Get(stage, '/root/Cube')
  cube_xform.AddTranslateOp(opSuffix='fuzz_translate').Set((0.5, -0.4, 0.2))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_translate_modification_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_translate_modification_modified_usd.png'
  )
  test_helpers.robust_assert_close(
