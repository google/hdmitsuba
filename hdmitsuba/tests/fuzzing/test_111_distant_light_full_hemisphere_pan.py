...
"""Fuzz testing: full hemisphere rotational pan modification on DistantLight in USD stage."""
...
def test_distant_light_full_hemisphere_pan():
  ...
  test_helpers.write_image(
      image_hd_initial,
      'test_distant_light_full_hemisphere_pan_initial_hd.png',
  )
  test_helpers.write_image(
      image_usd_initial,
      'test_distant_light_full_hemisphere_pan_initial_usd.png',
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: rotate distant light 180 deg in azimuth
  xform = UsdGeom.Xformable.Get(stage, '/root/Area')
  xform.AddRotateXYZOp(opSuffix='fuzz_pan').Set((0, 0, 180))
  ...
  test_helpers.write_image(
      image_hd_modified,
      'test_distant_light_full_hemisphere_pan_modified_hd.png',
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_distant_light_full_hemisphere_pan_modified_usd.png',
  )
  test_helpers.robust_assert_close(
