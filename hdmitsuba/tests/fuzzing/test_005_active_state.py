...
"""Fuzz testing: active state modification on USD stage."""
...
def test_active_modification():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_active_modification_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_active_modification_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.05
  )

  # Modification: Set Active False
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_active_modification_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_active_modification_modified_usd.png'
  )
  test_helpers.robust_assert_close(
