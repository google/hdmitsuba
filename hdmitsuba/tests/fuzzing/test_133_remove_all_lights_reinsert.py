...
"""Fuzz testing: complete light hierarchy pruning and reinsertion modification on USD stage."""
...
def test_remove_all_lights_reinsert():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_remove_all_lights_reinsert_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_remove_all_lights_reinsert_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Disable original light and reinsert new SphereLight
  orig_light = stage.GetPrimAtPath('/root/Light/Light')
  orig_light.SetActive(False)

  new_light = UsdLux.SphereLight.Define(stage, '/root/FreshSphereLight')
  new_light.CreateTreatAsPointAttr(False)
  new_light.CreateRadiusAttr(0.5)
  new_light.CreateIntensityAttr(50.0)
  new_light.CreateColorAttr(Gf.Vec3f(0.8, 0.8, 0.9))
  new_light.AddTranslateOp().Set((0.0, 3.0, 3.0))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_remove_all_lights_reinsert_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_remove_all_lights_reinsert_modified_usd.png'
  )
  test_helpers.robust_assert_close(
