...
"""Fuzz testing: irradiancemeter scene transform modification on USD stage."""
...
def test_irradiancemeter_modification():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_irradiancemeter_modification_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_irradiancemeter_modification_initial_usd.png'
  )
  ...
  cube_xform.AddTranslateOp(opSuffix='fuzz_trans').Set((0.5, 0.5, 0.5))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_irradiancemeter_modification_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_irradiancemeter_modification_modified_usd.png'
  )
  test_helpers.robust_assert_close(
