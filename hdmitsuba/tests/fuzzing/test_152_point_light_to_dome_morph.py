...
"""Fuzz testing: in-place emitter class morphing modification from Point to DomeLight on USD stage."""
...
def test_point_light_to_dome_morph():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_point_light_to_dome_morph_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_point_light_to_dome_morph_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Morph light type to DomeLight
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_point_light_to_dome_morph_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_point_light_to_dome_morph_modified_usd.png'
  )
  test_helpers.robust_assert_close(
