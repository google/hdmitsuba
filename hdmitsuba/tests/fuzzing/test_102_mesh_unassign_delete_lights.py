...
"""Fuzz testing: material unassigning and light removal modification on USD stage."""
...
def test_mesh_unassign_delete_lights():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_mesh_unassign_delete_lights_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_mesh_unassign_delete_lights_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Unbind material and deactivate light
  mesh = stage.GetPrimAtPath('/root/Cube/Cube')
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_mesh_unassign_delete_lights_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_mesh_unassign_delete_lights_modified_usd.png'
  )
  test_helpers.robust_assert_close(
