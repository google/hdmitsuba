...
"""Fuzz testing: extreme transparent clearcoat mirror layer modification on USD stage."""
...
def test_extreme_clearcoat_mirror_surface():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_extreme_clearcoat_mirror_surface_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial,
      'test_extreme_clearcoat_mirror_surface_initial_usd.png',
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Set clearcoat 1.0 and clearcoatRoughness 0.0
  shader = UsdShade.Shader.Get(
      stage, '/root/_materials/Material/Principled_BSDF'
  )
  shader.GetInput('clearcoat').Set(1.0)
  shader.GetInput('clearcoatRoughness').Set(0.0)
  ...
  test_helpers.write_image(
      image_hd_modified,
      'test_extreme_clearcoat_mirror_surface_modified_hd.png',
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_extreme_clearcoat_mirror_surface_modified_usd.png',
  )
  test_helpers.robust_assert_close(
