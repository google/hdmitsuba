...
"""Fuzz testing: dynamic addition of new geometry prim to USD stage."""
...
def test_add_new_prim():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_add_new_prim_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_add_new_prim_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Define a new Sphere prim and translate it next to the cube
  sphere = UsdGeom.Sphere.Define(stage, '/root/FuzzSphere')
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_add_new_prim_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_add_new_prim_modified_usd.png'
  )
  test_helpers.robust_assert_close(
