...
"""Fuzz testing: grazing incidence camera rotation modification under IrradianceMeter view on USD stage."""
...
def test_irradiancemeter_grazing_angle():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_irradiancemeter_grazing_angle_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_irradiancemeter_grazing_angle_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Rotate Camera to grazing angle
  cam_xform = UsdGeom.Xformable.Get(stage, '/root/Camera')
  cam_xform.AddRotateXYZOp(opSuffix='fuzz_grazing').Set((88.0, 0.0, 0.0))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_irradiancemeter_grazing_angle_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_irradiancemeter_grazing_angle_modified_usd.png',
  )
  test_helpers.robust_assert_close(
