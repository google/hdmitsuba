...
"""Fuzz testing: extreme massive planar width and height modification on RectLight in USD stage."""
...
def test_rect_super_planar():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_rect_super_planar_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_rect_super_planar_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: width and height to super planar wall
  rect = UsdLux.RectLight.Get(stage, '/root/Area/Area')
  rect.GetWidthAttr().Set(20.0)
  rect.GetHeightAttr().Set(20.0)
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_rect_super_planar_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_rect_super_planar_modified_usd.png'
  )
  test_helpers.robust_assert_close(
