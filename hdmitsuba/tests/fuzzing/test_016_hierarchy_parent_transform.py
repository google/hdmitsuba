...
"""Fuzz testing: parent hierarchy transform modification on USD stage."""
...
def test_parent_transform_modification():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_parent_transform_modification_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_parent_transform_modification_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.05
  )

  # Modification: Transform entire /root
  root_xform = UsdGeom.Xformable.Get(stage, '/root')
  root_xform.AddRotateZOp(opSuffix='fuzz_root_rotate').Set(15.0)
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_parent_transform_modification_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_parent_transform_modification_modified_usd.png',
  )
  test_helpers.robust_assert_close(
