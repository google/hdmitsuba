...
"""Fuzz testing: dual frame focal sweep from ultra-wide to telephoto on USD stage."""
...
def test_camera_perspective_wide_tele():
  ...
  # Mod 1: Ultra-wide focal length (0.1)
  camera.GetFocalLengthAttr().Set(0.1)
  ...
  # Mod 2: Telephoto focal length (3.5)
  camera.GetFocalLengthAttr().Set(3.5)
