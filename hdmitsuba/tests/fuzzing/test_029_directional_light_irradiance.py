...
"""Fuzz testing: directional light irradiance modification on USD stage."""
...
def test_directional_light_intensity():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_directional_light_intensity_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_directional_light_intensity_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Update intensity
  dist_light = UsdLux.DistantLight.Get(stage, '/root/Area/Area')
  dist_light.GetIntensityAttr().Set(2.5)
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_directional_light_intensity_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_directional_light_intensity_modified_usd.png'
  )
  test_helpers.robust_assert_close(
