...
"""Fuzz testing: rotation modification on USD stage."""
...
def test_rotate_modification():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_rotate_modification_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_rotate_modification_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.05
  )

  # Modification: Rotate Cube
  cube_xform = UsdGeom.Xformable.Get(stage, '/root/Cube')
  cube_xform.AddRotateXYZOp(opSuffix='fuzz_rotate').Set((45.0, 30.0, 15.0))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_rotate_modification_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_rotate_modification_modified_usd.png'
  )
  test_helpers.robust_assert_close(
