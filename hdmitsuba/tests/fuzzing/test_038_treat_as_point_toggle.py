...
"""Fuzz testing: treatAsPoint attribute toggle on sphere light in USD stage."""
...
def test_treat_as_point_toggle():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_treat_as_point_toggle_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_treat_as_point_toggle_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Toggle treatAsPoint
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_treat_as_point_toggle_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_treat_as_point_toggle_modified_usd.png'
  )
  test_helpers.robust_assert_close(
