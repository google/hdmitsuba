...
"""Fuzz testing: partial diffuse terminal unlinking alongside displacement mapping modification on USD stage."""
...
def test_displacement_diffuse_clear():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_displacement_diffuse_clear_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_displacement_diffuse_clear_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Disconnect diffuseColor input
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_displacement_diffuse_clear_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_displacement_diffuse_clear_modified_usd.png'
  )
  test_helpers.robust_assert_close(
