...
"""Fuzz testing: full master material terminal unlinking modification on USD stage."""
...
def test_nodegraph_disconnected_shading():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_nodegraph_disconnected_shading_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_nodegraph_disconnected_shading_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: disconnect surface output connection on encapsulation material
  mat = UsdShade.Material.Get(stage, '/root/_materials/encapsulation')
  mat.GetOutput('surface').ClearSources()
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_nodegraph_disconnected_shading_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_nodegraph_disconnected_shading_modified_usd.png',
  )
  test_helpers.robust_assert_close(
