...
"""Fuzz testing: material binding switching modification on USD stage."""
...
def test_rebind_multiple_materials():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_rebind_multiple_materials_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_rebind_multiple_materials_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Rebind subset red to blue material and vice versa
  ...
  UsdShade.MaterialBindingAPI(subset_red).Bind(mat_blue)
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_rebind_multiple_materials_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_rebind_multiple_materials_modified_usd.png'
  )
  test_helpers.robust_assert_close(
