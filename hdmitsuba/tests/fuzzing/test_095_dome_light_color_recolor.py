...
"""Fuzz testing: color spectrum modification on DomeLight in USD stage."""
...
def test_dome_color_recolor():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_dome_color_recolor_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_dome_color_recolor_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: recolor dome light
  env_light = UsdLux.DomeLight.Get(stage, '/root/env_light')
  env_light.GetColorAttr().Set(Gf.Vec3f(0.1, 0.9, 0.2))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_dome_color_recolor_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_dome_color_recolor_modified_usd.png'
  )
  test_helpers.robust_assert_close(
