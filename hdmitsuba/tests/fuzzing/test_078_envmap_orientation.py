...
"""Fuzz testing: orientation rotation modification on Environment Map in USD stage."""
...
def test_envmap_orientation():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_envmap_orientation_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_envmap_orientation_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: rotate envmap
  env_xform = UsdGeom.Xformable.Get(stage, '/root/env_light')
  env_xform.AddRotateXYZOp(opSuffix='fuzz_orient').Set((0, 0, 180))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_envmap_orientation_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_envmap_orientation_modified_usd.png'
  )
  test_helpers.robust_assert_close(
