...
"""Fuzz testing: consecutive step active state toggle modification on USD stage."""
...
def test_active_reactivation_rapid_fire():
  ...
  # Mod 2: Reactivate Cube and Deactivate Light
  cube.SetActive(True)
  light = stage.GetPrimAtPath('/root/Light')
