...
"""Fuzz testing: dynamic addition of distant light to USD stage."""
...
def test_add_distant_light():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_add_distant_light_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_add_distant_light_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Define a DistantLight
  dist_light = UsdLux.DistantLight.Define(stage, '/root/DistantLight')
  dist_light.CreateIntensityAttr(3.0)
  dist_light.CreateColorAttr(Gf.Vec3f(0.8, 0.9, 1.0))
  dist_light.AddRotateXYZOp().Set((45, 0, 0))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_add_distant_light_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_add_distant_light_modified_usd.png'
  )
  test_helpers.robust_assert_close(
