...
"""Fuzz testing: extreme softness limits modification on USD stage."""
...
def test_shaping_softness_extremes():
  ...
  # Mod 1: Softness 0.0
  shaping_api.GetShapingConeSoftnessAttr().Set(0.0)
  ...
  # Mod 2: Softness 1.0
  shaping_api.GetShapingConeSoftnessAttr().Set(1.0)
