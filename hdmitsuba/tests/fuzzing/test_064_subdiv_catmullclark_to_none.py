...
"""Fuzz testing: subdivision scheme modification on USD stage."""
...
def test_subdiv_scheme_change():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_subdiv_scheme_change_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_subdiv_scheme_change_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Set subdivisionScheme to none
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_subdiv_scheme_change_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_subdiv_scheme_change_modified_usd.png'
  )
  test_helpers.robust_assert_close(
