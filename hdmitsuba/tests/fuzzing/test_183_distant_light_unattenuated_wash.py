...
"""Fuzz testing: intensive unattenuated wash brightness modification on DistantLight in USD stage."""
...
def test_distant_light_unattenuated_wash():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_distant_light_unattenuated_wash_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial,
      'test_distant_light_unattenuated_wash_initial_usd.png',
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Overdrive distant light intensity
  light = UsdLux.DistantLight.Get(stage, '/root/Area/Area')
  ...
  test_helpers.write_image(
      image_hd_modified,
      'test_distant_light_unattenuated_wash_modified_hd.png',
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_distant_light_unattenuated_wash_modified_usd.png',
  )
  test_helpers.robust_assert_close(
