...
"""Fuzz testing: extreme narrow depth clipping plane squeeze modification on USD stage."""
...
def test_extreme_aperture_clipping_squeeze():
  ...
  test_helpers.write_image(
      image_hd_initial,
      'test_extreme_aperture_clipping_squeeze_initial_hd.png',
  )
  test_helpers.write_image(
      image_usd_initial,
      'test_extreme_aperture_clipping_squeeze_initial_usd.png',
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Set tight clipping range window
  camera = UsdGeom.Camera.Get(stage, '/root/Camera/Camera')
  camera.GetClippingRangeAttr().Set(Gf.Vec2f(3.0, 15.0))
  ...
  test_helpers.write_image(
      image_hd_modified,
      'test_extreme_aperture_clipping_squeeze_modified_hd.png',
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_extreme_aperture_clipping_squeeze_modified_usd.png',
  )
  test_helpers.robust_assert_close(
