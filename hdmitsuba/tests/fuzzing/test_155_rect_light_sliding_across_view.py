...
"""Fuzz testing: translation modification sliding RectLight across camera optical path in USD stage."""
...
def test_rect_light_sliding_across_view():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_rect_light_sliding_across_view_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_rect_light_sliding_across_view_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Translate rect light across view
  rect_xform = UsdGeom.Xformable.Get(stage, '/root/Area')
  rect_xform.AddTranslateOp(opSuffix='fuzz_slide').Set((1.5, 0.0, -1.0))
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_rect_light_sliding_across_view_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified,
      'test_rect_light_sliding_across_view_modified_usd.png',
  )
  test_helpers.robust_assert_close(
