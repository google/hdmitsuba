...
"""Fuzz testing: subdivision mesh points modification on USD stage."""
...
def test_subdiv_points_mutation():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_subdiv_points_mutation_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_subdiv_points_mutation_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: scale points non-uniformly
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_subdiv_points_mutation_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_subdiv_points_mutation_modified_usd.png'
  )
  test_helpers.robust_assert_close(
