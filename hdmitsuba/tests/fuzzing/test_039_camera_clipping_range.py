...
"""Fuzz testing: camera clipping range modification on USD stage."""
...
def test_camera_clipping_range():
  ...
  test_helpers.write_image(
      image_hd_initial, 'test_camera_clipping_range_initial_hd.png'
  )
  test_helpers.write_image(
      image_usd_initial, 'test_camera_clipping_range_initial_usd.png'
  )
  test_helpers.robust_assert_close(
      image_hd_initial[..., :3], image_usd_initial, atol=0.2
  )

  # Modification: Update clippingRange
  ...
  test_helpers.write_image(
      image_hd_modified, 'test_camera_clipping_range_modified_hd.png'
  )
  test_helpers.write_image(
      image_usd_modified, 'test_camera_clipping_range_modified_usd.png'
  )
  test_helpers.robust_assert_close(
